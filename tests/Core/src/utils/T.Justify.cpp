...
TEST(Justify, NoWrapBasic) {
    ...
    expectVecNear(res.line, {0.F, 15.F, 40.F}, 1e-5F);
    EXPECT_NEAR(res.total_size, 70.F, 1e-5F);
}

TEST(Justify, WrapOneLineAllFitStart) {
    std::vector<f32> sizes{10.F, 10.F, 10.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::START, Justify<f32>::LineMode::START, 100.F);
    expectVecNear(line, {0.F, 15.F, 30.F}, 1e-5F);
}

TEST(Justify, WrapOneLineAllFitLastLineCenter) {
    std::vector<f32> sizes{10.F, 10.F, 10.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::START, Justify<f32>::LineMode::CENTER, 100.F);
...
TEST(Justify, WrapOneLineMinGapStopsBeforeOverflow) {
    ...
    auto line = Justify<f32>::wrapOneLine(sizes, 10.F, Justify<f32>::LineMode::START, Justify<f32>::LineMode::START, 100.F);
    expectVecNear(line, {0.F, 50.F}, 1e-5F);
}

TEST(Justify, WrapLinesMultiLine) {
    std::vector<f32> sizes{30.F, 30.F, 30.F};
    auto lines = Justify<f32>::wrapLines(sizes, 10.F, Justify<f32>::LineMode::START, Justify<f32>::LineMode::CENTER, 80.F);
...
TEST(Justify, NoWrapEmpty) {
    ...
    auto res = Justify<f32>::noWrap(sizes, 5.F);
    EXPECT_TRUE(res.line.empty());
    EXPECT_NEAR(res.total_size, 0.F, 1e-6F);
}

TEST(Justify, JustifySpaceBetweenAllFit) {
    std::vector<f32> sizes{10.F, 10.F, 10.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::SPACE_BETWEEN, Justify<f32>::LineMode::SPACE_BETWEEN, 100.F);
    expectVecNear(line, {0.F, 45.F, 90.F}, 1e-5F);
}

TEST(Justify, JustifySpaceAroundSingleItemCenters) {
    std::vector<f32> sizes{20.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::SPACE_AROUND, Justify<f32>::LineMode::SPACE_AROUND, 100.F);
    expectVecNear(line, {40.F}, 1e-5F);
}

TEST(Justify, JustifySpaceEvenlySingleItemCenters) {
    std::vector<f32> sizes{20.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::SPACE_EVENLY, Justify<f32>::LineMode::SPACE_EVENLY, 100.F);
    expectVecNear(line, {40.F}, 1e-5F);
}

TEST(Justify, JustifySpaceEvenlyThreeItems) {
    std::vector<f32> sizes{10.F, 10.F, 10.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::SPACE_EVENLY, Justify<f32>::LineMode::SPACE_EVENLY, 70.F);
    expectVecNear(line, {10.F, 30.F, 50.F}, 1e-5F);
}

TEST(Justify, JustifyEndExactSlack) {
    std::vector<f32> sizes{10.F, 10.F, 10.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::END, Justify<f32>::LineMode::END, 45.F);
    expectVecNear(line, {5.F, 20.F, 35.F}, 1e-5F);
}

TEST(Justify, JustifyCenterExactSlack) {
    std::vector<f32> sizes{10.F, 10.F, 10.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 5.F, Justify<f32>::LineMode::CENTER, Justify<f32>::LineMode::CENTER, 45.F);
    expectVecNear(line, {2.5F, 17.5F, 32.5F}, 1e-5F);
}

TEST(Justify, WrapOneLineExactFitStart) {
    std::vector<f32> sizes{30.F, 40.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 10.F, Justify<f32>::LineMode::START, Justify<f32>::LineMode::START, 80.F);
    expectVecNear(line, {0.F, 40.F}, 1e-5F);
}

TEST(Justify, WrapLinesLastLineCentered) {
    std::vector<f32> sizes{25.F, 25.F, 25.F};
    auto lines = Justify<f32>::wrapLines(sizes, 10.F, Justify<f32>::LineMode::START, Justify<f32>::LineMode::CENTER, 70.F);
    ASSERT_EQ(lines.size(), 2U);
...
TEST(Justify, WrapOneLineStopsWhenMinGapWouldOverflow) {
    std::vector<f32> sizes{40.F, 40.F, 40.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 20.F, Justify<f32>::LineMode::START, Justify<f32>::LineMode::START, 100.F);
    expectVecNear(line, {0.F, 60.F}, 1e-5F);
}

TEST(Justify, WrapOneLineTooSmallForSecondItem) {
    std::vector<f32> sizes{30.F, 30.F};
    auto line = Justify<f32>::wrapOneLine(sizes, 20.F, Justify<f32>::LineMode::SPACE_EVENLY, Justify<f32>::LineMode::SPACE_EVENLY, 70.F);
...
TEST(Justify, IntegerTypeCenterUsesIntegerDivision) {
    ...
    auto line = Justify<int>::wrapOneLine(sizes, 5, Justify<int>::LineMode::CENTER, Justify<int>::LineMode::CENTER, 46);
...
TEST(Justify, NoWrapBasicInt) {
    ...
    expectVecEq(res.line, std::vector<int>({0, 15, 40}));
    EXPECT_EQ(res.total_size, 70);
}

TEST(Justify, WrapOneLineAllFitStartInt) {
    std::vector<int> sizes{10, 10, 10};
    auto line = Justify<int>::wrapOneLine(sizes, 5, Justify<int>::LineMode::START, Justify<int>::LineMode::START, 100);
    expectVecEq(line, std::vector<int>({0, 15, 30}));
}

TEST(Justify, WrapOneLineAllFitLastLineCenterInt) {
    std::vector<int> sizes{10, 10, 10};
    auto line = Justify<int>::wrapOneLine(sizes, 5, Justify<int>::LineMode::START, Justify<int>::LineMode::CENTER, 100);
...
TEST(Justify, WrapOneLineMinGapStopsBeforeOverflowInt) {
    ...
    auto line = Justify<int>::wrapOneLine(sizes, 10, Justify<int>::LineMode::START, Justify<int>::LineMode::START, 100);
    expectVecEq(line, std::vector<int>({0, 50}));
}

TEST(Justify, WrapLinesMultiLineInt) {
    std::vector<int> sizes{30, 30, 30};
    auto lines = Justify<int>::wrapLines(sizes, 10, Justify<int>::LineMode::START, Justify<int>::LineMode::CENTER, 80);
    ASSERT_EQ(lines.size(), 2U);
...
TEST(Justify, TightLineOnlyFirstFitsNoFollowingGap) {
    ...
    auto line = Justify<int>::wrapOneLine(sizes, 7, Justify<int>::LineMode::START, Justify<int>::LineMode::START, 16);
    expectVecEq(line, std::vector<int>({0}));
}
...
TEST(Justify, SpaceBetween3x10on100) {
    std::vector<int> sizes{10, 10, 10};
    auto line = Justify<int>::wrapOneLine(sizes, 5, Justify<int>::LineMode::SPACE_BETWEEN, Justify<int>::LineMode::SPACE_BETWEEN, 100);
    expectVecEq(line, std::vector<int>({0, 45, 90}));
}

TEST(Justify, SpaceAround3x10on100) {
    std::vector<int> sizes{10, 10, 10};
    auto line = Justify<int>::wrapOneLine(sizes, 5, Justify<int>::LineMode::SPACE_AROUND, Justify<int>::LineMode::SPACE_AROUND, 100);
    expectVecEq(line, std::vector<int>({11, 44, 77}));
}

TEST(Justify, SpaceEvenly3x10on100) {
    std::vector<int> sizes{10, 10, 10};
    auto line = Justify<int>::wrapOneLine(sizes, 5, Justify<int>::LineMode::SPACE_EVENLY, Justify<int>::LineMode::SPACE_EVENLY, 100);
    expectVecEq(line, std::vector<int>({17, 44, 71}));
}

TEST(Justify, WrapLinesZeroGapInt) {
    std::vector<int> sizes{5, 5, 5, 5, 5};
    auto lines = Justify<int>::wrapLines(sizes, 0, Justify<int>::LineMode::START, Justify<int>::LineMode::CENTER, 12);
...
TEST(Justify, NoWrapSingleInt) {
    ...
    expectVecEq(res.line, std::vector<int>({0}));
    EXPECT_EQ(res.total_size, 17);
}

TEST(Justify, WrapOneLineExactFitBoundaryInt) {
    std::vector<int> sizes{25, 10, 15};
    auto line = Justify<int>::wrapOneLine(sizes, 5, Justify<int>::LineMode::START, Justify<int>::LineMode::START, 60);
