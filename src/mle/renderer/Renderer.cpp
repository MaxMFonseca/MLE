...
void Impl::createSamplers() {
    ...
    linear_sampler_ci.addressModeU = vk::SamplerAddressMode::eClampToBorder;
    linear_sampler_ci.addressModeV = vk::SamplerAddressMode::eClampToBorder;
    linear_sampler_ci.addressModeW = vk::SamplerAddressMode::eClampToBorder;
    linear_sampler_ci.anisotropyEnable = vk::False;
    linear_sampler_ci.borderColor = vk::BorderColor::eFloatOpaqueBlack;
    ...
    nearest_sampler_ci.addressModeU = vk::SamplerAddressMode::eClampToBorder;
    nearest_sampler_ci.addressModeV = vk::SamplerAddressMode::eClampToBorder;
    nearest_sampler_ci.addressModeW = vk::SamplerAddressMode::eClampToBorder;
    nearest_sampler_ci.anisotropyEnable = vk::False;
    nearest_sampler_ci.borderColor = vk::BorderColor::eFloatOpaqueBlack;
